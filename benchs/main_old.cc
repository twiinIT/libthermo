...
main()
{
    ...
    double Tref = 288.15;
    {
        ...
        std::cout << "\n"
                  << "Reference values Ideal gas" << std::endl;
        ...
        std::cout << "\nLoop tests" << std::endl;
        benchmark_loop(gas, 1000000, 20, 10);

#ifdef LIBTHERMO_USE_XTENSOR
        std::cout << "\nVector tests" << std::endl;
        benchmark_vector<IdealGas<double>&, double>(gas, 1000000, 10, 10);
#endif
    }

    //     {
    //         PolyIdealGas gas(PolyIdealGasProps<double, 8>({ 0., 0., 0., 0., 0., 0., 0., 1004.4 }, 0., 287.05287));

    //         std::cout << "\n"
    //                   << "Reference values Poly gas" << std::endl;
    //         std::cout << "cp -> " << gas.cp(Tref) << std::endl;
    //         std::cout << "gamma -> " << gas.gamma(Tref) << std::endl;
    //         std::cout << "h -> " << gas.h(Tref) << std::endl;
    //         std::cout << "phi -> " << gas.phi(Tref) << std::endl;
    ...
    //         PolyIdealGas gas_float(PolyIdealGasProps<float, 8>({ 0., 0., 0., 0., 0., 0., 0., 1004.4 }, 0.,
    //         287.05287)); std::cout << "\nVector tests 1M float" << std::endl; benchmark_vector(gas_float, 1000000,
    //         10, 10);
    // #endif
    //     }
