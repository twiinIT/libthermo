...
#define LIBTHERMO_VERSION_MINOR 4
...
#define LIBTHERMO_VERSION (LIBTHERMO_VERSION_MAJOR * 10000 + LIBTHERMO_VERSION_MINOR * 100 + LIBTHERMO_VERSION_PATCH)
#define LIBTHERMO_VERSION_STRING                                                                                       \
    __LIBTHERMO_STRINGIZE(LIBTHERMO_VERSION_MAJOR)                                                                     \
    "." __LIBTHERMO_STRINGIZE(LIBTHERMO_VERSION_MINOR) "." __LIBTHERMO_STRINGIZE(LIBTHERMO_VERSION_PATCH)
