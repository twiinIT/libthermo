...
namespace thermo
{
    ...
    public:
        ...
        private:
            ...
            std::size_t m_remainder = 0;   ///< remainder obtained after dividing the total size by the number of blocks

        };  // class blocks

        template <typename F>
        void run_blocks(const T first_index, const T index_after_last, F&& func, const std::size_t min_size = 0);
...
#include "./detail/thread_pool_inl.hpp"
